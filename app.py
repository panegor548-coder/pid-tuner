...
# --- ВКЛАДКИ ИНТЕРФЕЙСА (Руководство и Шпаргалка идут первыми) ---
...
if file_bytes is None:
    st.sidebar.warning("👈 Загрузите файл лога для работы в разделах сводки, PID и фильтров.")
    # Предотвращаем расчеты, но даем пользователю посмотреть первые две вкладки
    st.stop()
